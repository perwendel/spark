...
public class GenericSecureIntegrationTest
{
    ...
    public static void setup()
    {
        ...
        //note that the keystore stuff is retrieved from SparkTestUtil which respects JVM params for keystore, password
        //but offers a default included store if not.
        Spark.setSecure(SparkTestUtil.getKeyStoreLocation(), SparkTestUtil.getKeystorePassword(), null, null);

...
public class Spark {
     ...
     * This has to be called before any route mapping is done.
     * You have to supply a keystore file, truststore file is optional (keystore will be reused).
     *
     * This method is only relevant when using embedded Jetty servers.  It should not be used
     * if you are using Servlets, where you will need to secure the connection in the servlet
     * container
     *
     ...
     */
    public synchronized static void setSecure(String keystoreFile, String keystorePassword, String truststoreFile,

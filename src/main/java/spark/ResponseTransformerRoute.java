 ...
 * ResponseTransformerRoute instead of returning the result of calling toString() as body, it returns the result of calling render method.
 * 
 * The primary purpose of this kind of Route is provide a way to create generic and reusable transformers. For example to convert an Object to JSON format.
 * 
 * @author alex
 *
 */

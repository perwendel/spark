...
public class ClassPathResourceHandler {
     ...
     */
    public ClassPathResource getResource(HttpServletRequest request) throws MalformedURLException {
        String servletPath;
        String pathInfo;
     ...
     */
    private ClassPathResource getResource(String path) throws MalformedURLException {

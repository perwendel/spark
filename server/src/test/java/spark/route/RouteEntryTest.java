...
public class RouteEntryTest {
    ...
    public void testMatches_NotAllPathsAndDidNotMatchHttpMethod() {
        ...
        Assert.assertFalse("Should return false because path names did not match",
    ...
    public void testMatches_RouteDoesNotEndWithSlash() {
        ...
        Assert.assertFalse("Should return false because route path does not end with a slash, does not end with " +
    ...
    public void testMatches_PathDoesNotEndInSlash() {
        ...
        Assert.assertFalse("Should return false because route path ends with a slash while path supplied as parameter does" +
    ...
    public void testMatches_MatchingPaths() {
        ...
        Assert.assertTrue("Should return true because route path and path is exactly the same",
            entry.matches(HttpMethod.get, "/test/"));
    }
    ...
    public void testMatches_WithWildcardOnEntryPath() {
        ...
        Assert.assertTrue("Should return true because path specified is covered by the route path wildcard",
    ...
    public void testMatches_PathsDoNotMatch() {
        ...
        Assert.assertFalse("Should return false because path does not match route path",

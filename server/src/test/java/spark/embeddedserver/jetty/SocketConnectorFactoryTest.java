...
public class SocketConnectorFactoryTest {
    ...
    public void testCreateSecureSocketConnector() throws Exception {
        ...
        Assert.assertTrue("Should return true because factory for SSL should have been set",
        ...
        Assert.assertEquals("Should return the Keystore file specified", keystoreFile,
            sslContextFactory.getKeyStoreResource().getFile().getName());

        Assert.assertEquals("Should return the Truststore file specified", truststoreFile,
